...
angular.module('contractualClienteApp')
    .controller('SeguimientoycontrolPlanTrabajoDocenteCargaDocumentosDocenteCtrl', function ($scope, $http, $translate, uiGridConstants, contratoRequest, administrativaRequest, nuxeo, $q, coreRequest, $window,$sce, adminMidRequest,$routeParams) {
...
self.gridOptions1 = {
  ...
  columnDefs: [{
    ...
    },
    {
      ...
      cellTemplate: 
      ' <a type="button" title="{{\'CAR_SOP\'| translate }}" type="button" class="fa fa-upload fa-lg  faa-shake animated-hover" ng-click="grid.appScope.cargaDocumentosDocente.cargar_soportes(row.entity); "data-toggle="modal" data-target="#modal_carga_soportes">',
      width: "10%"
    }
  ]
};
...
self.gridOptions1.data = [
  {
    "Actividad": "Globalia (Air Europa)"
  },
  {
    "Actividad": "Tinsa"
  },
  {
    "Actividad": "Casa del Libro"
  },
  {
    "Actividad": "Globalia (Air Europa)"
  },
